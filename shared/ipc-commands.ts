...
// Updater
export const APP_UPDATE_CHECK = 'APP:UPDATE_CHECK';
export const APP_UPDATE_PROGRESS = 'APP:UPDATE_PROGRESS';
export const APP_UPDATE_DONE = 'APP:UPDATE_DONE';
export const APP_UPDATE_ERROR = 'APP:UPDATE_ERROR';
export const APP_UPDATE_INSTALL = 'APP:UPDATE_INSTALL';
export const APP_UPDATE_TEST = 'APP:UPDATE_TEST';

// Cache
export const CACHE_LOGO = 'CACHE:LOGO';
export const CACHE_LOGO_RESPONSE = 'CACHE:LOGO_RESPONSE';
